        ...
        <table id="datatable" class="table table-striped table-bordered" width="100%" cellspacing="0">
            ...
            <tbody>
                {% for doc in docs %}
                    ...
                    <td>{% if doc.date.day < 10%}0{% endif %}{{ doc.date.day }}/{% if doc.date.month < 10%}0{% endif %}{{ doc.date.month }}/{{ doc.date.year }} {% if doc.date.hour < 10%}0{% endif %}{{ doc.date.hour }}:{% if doc.date.minute < 10%}0{% endif %}{{ doc.date.minute }}{% if doc.date.seconde < 10%}0{% endif %}{{ doc.date.seconde }}</td>
                    {%  if  doc.description %}
